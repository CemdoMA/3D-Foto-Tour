(function()
{
	...
	function init()
	{
	  ...
	  var w_v = viewer.clientWidth;
	  var h_v = viewer.clientHeight;
	  ...
	  persp.style.top="0px";
	  persp.style.perspective=perspective+"px";
	  persp.style.transformStyle="preserve-3d";
	  persp.style.perspectiveOrigin="50% 50%";
	  persp.style.transformOrigin="50% 50%";
	  persp.style.marginLeft=(-(cube_panel_size-w_v)/2)+"px";
	  ...
	  object3D.style.transformStyle="preserve-3d";
	  object3D.style.transform="rotate3d(0, 0, 0 0)";
	  ...
	  for(var i=0;i<objects.length;i++)
	  {
		  ...
		  cube_side.style.transformStyle="preserve-3d";
		...
		cube_side.addEventListener('pointerup', mouseUpHandler.bind(this),false);
		  ...
		  cube_side.style.backfaceVisibility="hidden";
		  cube_side.style.webkitBackfaceVisibility="hidden";
